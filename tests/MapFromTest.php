...
class MapFromTest extends TestCase
{
    ...
    {
        $dto = new class (count: 42) extends Dto {
            #[MapFrom('count')]
    ...
    {
        $dto = new class (['John', 'Doe']) extends Dto {
            #[MapFrom(1)]
    ...
    {
        $dto = new class (['address' => ['city' => 'London']]) extends Dto {
    ...
    public function dto_can_have_numeric_keys_in_nested_dto()
    {
        ...
        $dtoOuter = new class ($data) extends Dto {
