...
use ACAT\Dto\Casters\ArrayCaster;
use ACAT\Dto\Dto;
...
class CustomCasterArgumentsTest extends TestCase
{
    ...
    public function test_it_throws_exception_when_casting_non_array()
    {
        ...
        $this->expectExceptionMessage(
            "Caster [ArrayCaster] each item must be an array or an instance of the specified item type [ACAT\Dto\Tests\Foo]."
        );
...
class BarIllogical extends Dto
{
    /** @var \ACAT\Dto\Tests\Foo[] */
    #[CastWith(ArrayCaster::class, itemType: Foo::class)]
...
class DTOWithArrayAccessImplementation extends Dto
{
    /** @var \ACAT\Dto\Tests\Foo[] */
    #[CastWith(ArrayCaster::class, itemType: Foo::class)]
...
class DTOWithArrayAccessIteratorAggregate extends Dto
{
    /** @var \ACAT\Dto\Tests\Foo[] */
    #[CastWith(ArrayCaster::class, itemType: Foo::class)]
...
class DTOWithArrayAccessIterator extends Dto
{
    /** @var \ACAT\Dto\Tests\Foo[] */
    #[CastWith(ArrayCaster::class, itemType: Foo::class)]
...
class DTOWithArrayObject extends Dto
{
    /** @var \ACAT\Dto\Tests\Foo[] */
    #[CastWith(ArrayCaster::class, itemType: Foo::class)]
